...
title: "[AI 기초] MCP(Model Context Protocol): AI에게 '손과 발'을 달아주는 표준 인터페이스 (feat. JDBC)"

date: 2025-12-13 19:35:00 +0900
...
**MCP(Model Context Protocol)**는 Anthropic(Claude 개발사)이 만든 **오픈 표준 프로토콜**이에요.
